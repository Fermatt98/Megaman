...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "MegaMan", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "MegaMan";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "MegaMan", null, { width: 512, height: 480 });
